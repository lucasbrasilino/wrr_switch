...
add wave -noupdate -format Literal -radix hexadecimal /testbench/u_board/nf2_top/nf2_core/user_data_path/input_arbiter/rd_en
...
add wave -noupdate -format Literal -radix binary /testbench/u_board/nf2_top/nf2_core/user_data_path/input_arbiter/cur_queue
add wave -noupdate -format Literal -radix binary /testbench/u_board/nf2_top/nf2_core/user_data_path/input_arbiter/cur_queue_next
...
WaveRestoreCursors {{Cursor 1} {24051277 ps} 0}
...
update
WaveRestoreZoom {0 ps} {236704650 ps}
